...
\`\`\`
      `,
        ...
        servers: [
            {
                url: `http://localhost:${config_1.config.port}${config_1.config.apiPrefix}`,
                description: '开发环境'
            },
            {
                url: `https://api.lndx.com${config_1.config.apiPrefix}`,
                description: '生产环境'
            }
        ],
        components: {
...
const setupSwagger = (app) => {
    ...
    app.get('/docs', swagger_ui_express_1.default.setup(swaggerSpec, swaggerUiOptions));
    // API前缀下的文档（供前端访问）
    const apiPrefix = config_1.config.apiPrefix || '/api';
    app.use(`${apiPrefix}/docs`, swagger_ui_express_1.default.serve);
    app.get(`${apiPrefix}/docs`, swagger_ui_express_1.default.setup(swaggerSpec, swaggerUiOptions));
    // 提供JSON格式的API文档
    ...
    console.log(`   - Swagger UI: http://localhost:${config_1.config.port}/docs`);
    console.log(`   - API文档: http://localhost:${config_1.config.port}${apiPrefix}/docs`);
    console.log(`   - JSON格式: http://localhost:${config_1.config.port}/docs.json`);
};
