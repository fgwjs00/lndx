...
assertIncludes(mobileRegistration, 'identityPreviewUrls', 'mobile registration must show selected identity-image previews')
assertIncludes(mobileRegistration, 'URL.createObjectURL(file)', 'identity previews must use the locally selected image')
assertIncludes(mobileRegistration, 'URL.revokeObjectURL(previewUrl)', 'identity preview object URLs must be released')
assertIncludes(mobileRegistration, '照片预览，点击图片可查看大图', 'identity previews must explain the enlarge action')
